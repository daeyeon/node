...

{
  ...
  // const exitCodeAliasedInt32Array =
    // getHiddenValue(process, exitCode_aliased_Int32Array);
  ObjectDefineProperty(process, 'exitCode', {
    ...
    set(code) {
      if (code !== null && code !== undefined) {
        ...
        // exitCodeAliasedInt32Array[0] = value;
        // exitCodeAliasedInt32Array[1] = 1; // set
        process[kExitCode] = value;
      } else {
        // exitCodeAliasedInt32Array[0] = 0;
        // exitCodeAliasedInt32Array[1] = 0; // reset
